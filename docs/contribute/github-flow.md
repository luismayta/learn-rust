<!-- Space: Projects -->
<!-- Parent: LearnRust -->
<!-- Title: Contributing GithubFlow LearnRust -->
<!-- Label: LearnRust -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to learn-rust project on [GitHub](https://github.com/luismayta/learn-rust), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/learn-rust/pulls).
...
To follow the instructions in this guide and start contributing to learn-rust project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/learn-rust.git
```

Now your **upstream** points to **luismayta/learn-rust**.
...
git fetch upstream # assuming upstream is luismayta/learn-rust
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/learn-rust/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
