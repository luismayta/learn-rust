...
Contributions to learn-rust are welcome.

Feel free to use all of the contribution options:

- Contribute to learn-rust repositories on [GitHub](https://github.com/luismayta/learn-rust). See [Git flow](./contribute/github-flow.md).
...
Documentation is a part of the learn-rust code base. You can find the documentation files in the `doc/` subdirectory of the [main repository](https://github.com/luismayta/learn-rust). This means that the contribution process is the same for both the source code and documentation.
...
1.  See if a [Pull Request](https://github.com/luismayta/learn-rust/pulls) exists
    - Add some comments or review the code to help it along
    - Don\'t be afraid to comment when logic needs clarification
2.  Create a Fork and open a [Pull Request](https://github.com/luismayta/learn-rust/pulls) if needed

### Code Review

- Anyone can review code
- Any [Pull Request](https://github.com/luismayta/learn-rust/pulls) should be closed or merged within a week
